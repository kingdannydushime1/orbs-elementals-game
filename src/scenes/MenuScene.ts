...
import { loadCoins, loadLives, buyLives, hasLives, deductLife, MAX_LIVES, LIVES_COST, loadLastLevel } from '../utils/save';
...
export class MenuScene extends Phaser.Scene {
  ...
  create() {
    ...
    makeBtn('PLAY', h * 0.53, 800, () => {
      this.scene.start('GameScene', { levelId: loadLastLevel() });
    });
